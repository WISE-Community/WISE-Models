      {
         "title": "InputGraphComplete-Sunshine",
         ...
         "feedbacks": [
            {
               "pattern": "R[rising]||R[falling]||R[change]",
                "feedback": "<h3>Very Good!</h3><p style='border:20px;'> After you have run the model, check the graphs. Are the <strong>Sunshine</strong> line and the <strong>Temperature</strong> line similar?</p>"
            },
            {
               "pattern": "R[spans-x]&&R[g5pts]",
                "feedback": "<h3>Don't be a Lisa!</h3><p style='border:20px;'>It looks like you are changing the amount of Sunshine too often. Try either increasing the Sunshine slowly or just testing two different levels of Sunshine.</p>"
            },
            {
               "pattern": "R[spans-x]",
               "feedback": "<h3>Try Running the Model Again</h3><p style='border:20px;'>Try different levels of Sunshine to see if it affects the Temperature.</p>"
            },
            {
               "pattern": "R[g1pt]",
