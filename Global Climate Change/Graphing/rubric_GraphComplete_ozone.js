      {
         "title": "InputGraphComplete-Ozone-Concentration",
         ...
         "feedbacks": [
            {
               "pattern": "R[rising]||R[falling]||R[change]",
                "feedback": "<h3>Very Good!</h3><p style='border:20px;'> After you have run the model, check the graphs. Are the <strong>Ozone Concentration</strong> line and the <strong>Temperature</strong> line similar?</p>"
            },
            {
            ...
            {
               "pattern": "R[spans-x]",
               "feedback": "<h3>Try Running the Model Again</h3><p style='border:20px;'>Try different levels of Ozone Concentration to see if it affects the Temperature.</p>"
            },
            {
               "pattern": "R[g1pt]",
