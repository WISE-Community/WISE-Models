 ; Thermo software
; Oct 21, 2015 Bob
; Aug 31, 2016 Hiroki Added chooser for each material, which updates when a choice is selected instead of clicking on the material
...
to onOff                                 ; This is a forever loop
  if mode = "Running" [
    make-heat-flow
    every (.005 * grid-xmax)[
