;;; TODO
;;; 1) is temperature restarting?


;;GLOBAL CLIMATE CHANGE BASE MODEL
;; by: Mario M. Martinez, originally by Jonathan Vitale
;; February 2016
...
to setup-world
  ...
  create-Heats 250 [ ;; start with some heat energy in the earth
...
to execute
  ...
  ifelse ( ; any changes in input values
    ...
    or percent-electric != save-percent-electric
    )
  [
    reset
  ][
...
;;; Users have a choice about what they want to plot on the y-axis, if they click then update the graph to draw what has been saved
to set-Plot-Variable [var]
  clear-all-plots
  set Plot-Variable var
  let array []
  if (var = "Temperature")[
    set array save-temperature
  ]
  if (var = "CO2")[
    set array save-CO2
  ]
  ...
  if (var = "Energy Produced")[
    set array save-energy-produced
  ]

  set-current-plot-pen Plot-Variable
  ;show (word "length of array " length array)
  let i 0
  foreach array [
   plotxy i / 10 ?
   set i i + plot-interval
  ]
...
"" ""
PENS
"Temperature" 1.0 0 -8053223 true "" ""
"CO2" 1.0 0 -14070903 true "" ""
"Cost" 1.0 0 -14439633 true "" ""
...
191
120
Percent of electric cars\n(the rest will be gas fueled):
13
0.0
1
...
974
43
Plot Total Cost (Billions)
set-Plot-Variable \"Cost\"
NIL
1
T
OBSERVER
